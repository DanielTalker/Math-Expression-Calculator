...
public class MainTest {
     ...
     * The Grade part 1.
     */
    private static int gradePart1 = 0;
    /**
     * The Total tests.
     */
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            e1 = new Pow(new Plus(new Plus(new Var("x"), new Var("y")),
                    new Var("z")), new Num(2));
        ...
        try {
            ...
            e1 = new Div(new Plus(new Sin(new Num(1.0)), new Cos(new Num(1.0))), new Num(10.0));
            value = e1.evaluate();
        ...
        try {
            ...
            e1 = new Mult(new Log(new Mult(new Num(9), new Var("x")),
                    new Mult(new Num(9), new Var("x"))),
        ...
        try {
            ...
            e1 = new Plus(new Neg(new Mult(new Div(new Var("y"), new Neg(new Div(new Var("y"),
                    new Var("x")))),
            ...
            s = e1.toString().toLowerCase().replaceAll("\\s+", "").
                    replaceAll("\\s+", "");
            System.out.println(s);
            if (s.equals("(-0.0-(2.0+x))") || s.equals("(-0-(2+x))") || s.equals("(-(2.0+x))")
                    || s.equals("(-(2+x))")) {
                gradePart1++;
            } else {
                System.out.println("Test " + totalTests + " failed");
        ...
        try {
            ...
            e1 = new Minus(new Plus(new Pow(new Var("x"), new Num(2)),
        ...
        try {
            ...
            // expression: (0 - (x * 1 / 1))
            e1 = new Minus(new Num(0), new Div(new Mult(new Var("x"), new Num(1)),
                    new Num(1)));
            e1 = e1.simplify();
            s = e1.toString().toLowerCase().replaceAll("\\s+", "").
                    replaceAll("\\s+", "");
        ...
        try {
            totalTests++;
            // ans is : (((1.0*(-sin(x)))+(1.0/x))+((((0.0*x)-(1.0*1.0))/(x^2.0))+(((2.0*1.0)
            // *(x^(2.0-1.0)))*cos((x^2.0)))))


            // expression: ((cos(x) + log(e,x)) + (1/x + sin(x^2)))
            e1 = new Plus(new Plus(new Cos(new Var("x")), new Log(new Var("e"), new Var("x"))),
                    new Plus(new Div(new Num(1),
            ...
            s = e1.toString().toLowerCase().replaceAll("\\s+", "").
                    replaceAll("\\s+", "");
            System.out.println(s);
            if (s.equals("(((1.0*(-sin(x)))+(1.0/x))+((((0.0*x)-(1.0*1.0))/(x^2.0))"
                    + "+(((2.0*1.0)*(x^(2.0-1.0)))*cos((x^2.0)))))")
                    ||
        ...
        try {
            ...
            e1 = new Plus(new Mult(new Plus(new Num(3), new Num(6)), new Var("x")),
                    new Mult(new Mult(new Num(4),
        ...
        try {
            ...
            e1 = new Plus(new Mult(new Cos(new Pow(new Mult(new Num(5), new Var("x")),
                    new Num(7))), new Var("e")),
                    new Pow(new Var("y"), new Plus(new Div(new Var("x"), new Num(2)),
                            new Num(5))));
            assignment.clear();
        ...
        try {
            ...
            e1 = new Plus(new Mult(new Mult(new Var("x"), new Num(1)), new Num(1)),
                    new Minus(new Num(0), new Neg(new Plus(new Var("x"), new Num(0)))));
            e1 = e1.simplify();
            s = e1.toString().toLowerCase().replaceAll("\\s+", "").
                    replaceAll("\\s+", "");
            System.out.println(s);
        ...
        try {
            ...
            e1 = new Mult(new Mult(new Mult(new Mult(new Num(20), new Pow(new Var("x"),
                    new Num(5))), new Mult(new Num(3),
                    new Pow(new Var("e"), new Var("x")))),
                    new Cos(new Pow(new Var("x"), new Num(2)))),
                    new Minus(new Var("x"), new Var("x")));
            e1 = e1.simplify();
            s = e1.toString().toLowerCase().replaceAll("\\s+", "").
                    replaceAll("\\s+", "");
        ...
        try {
            ...
            e1 = new Mult(new Div(new Mult(new Pow(new Var("e"), new Var("x")),
                    new Pow(new Pow(new Var("e"),
                            new Var("x")), new Num(2))), new Pow(new Pow(new Var("e"),
                    new Var("x")), new Num(3))),
                    new Div(new Mult(new Pow(new Pow(new Var("e"), new Var("x")), new Num(4)),
                            new Pow(new Pow(new Var("e"), new Var("x")),
                                    new Num(3))), new Pow(new Pow(new Var("e"),
                            new Var("x")), new Num(7))));
        ...
        try {
            ...
            // ans is :
            e1 = new Sin(new Pow(new Var("e"), new Div(new Sin(new Var("x")),
                    new Cos(new Var("x")))));
            e1 = e1.differentiate("x");
            //e1 = e1.simplify();
            s = e1.toString().toLowerCase().replaceAll("\\s+", "").
            ...
            if (s.equals("(((e^(sin(x)/cos(x)))((((((1.0*cos(x))*cos(x))-((1.0(-sin(x)))*sin(x)))/(cos(x)^2.0))*log"
                    + "(e,e))+((sin(x)/cos(x))*0.0)))*cos((e^(sin(x)/cos(x)))))")
                    || s.equals("(((e^(sin(x)/cos(x)))((((((1*cos(x))*cos(x))-((1(-sin(x)))*sin(x)))/"
                    + "(cos(x)^2))*log(e,e))+((sin(x)/cos(x))*0)))*cos((e^(sin(x)/cos(x)))))")) {
                gradePart1++;
            }
        } catch (Exception exp) {
            System.out.println("Test " + totalTests + " exception");
